...
# todo, abstraeer para q subclasse la mama q tiene estas cosas y los modelos para cada entity les da insert etc
...
class database:
    ...
    #no es totalmente generico! le falta pasarle cualquier insert, tipo lo q se hace en objC
